...
@section('content')
{{ Form::open(array('url'=>'trainers/'.$trainer->id,'method'=>'post','role'=>'form','class'=>'form-horizontal','files'=>'true')) }}
<div class="col-sm-6">
    ...
    <div class="panel panel-white">
        ...
        <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input disabled type="text" name="name" value="{{ $trainer->trainer_name }}" placeholder="" id="form-field-13" class="form-control input-sm">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="form-field-13">
                    ...
                    <div class="col-sm-9">
                        <img src="{{url()}}/uploads/{{ $trainer->profile_picture }}" width="200px" height="200px">
                        <p></p>
                ...
                <div class="form-group" id="uploadImage" style="display: none">
                    ...
                    <div class="col-sm-9">
                        ...
                        {{ Form::file('profile_picture',['disabled'=>'disabled']) }}
                    </div>
                </div>             
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="form-field-13">
                    ...
                    <div class="col-sm-9">
                        <input disabled type="text" name="contact" value="{{ $trainer->contact }}" id="contact" placeholder="" id="form-field-13" class="form-control input-sm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="nric" id="nric" placeholder="" id="form-field-13" class="form-control input-sm" value="{{ $trainer->nric}}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input disabled type="email" name="email" value="{{ $trainer->email }}" id="email" placeholder="" id="form-field-13" class="form-control input-sm">
                        <span id="trainer_email_err"></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="date_of_birth" id="date_of_birth" placeholder="" id="form-field-14" class="form-control input-sm date-picker" value="{{ $trainer->date_of_birth }}">
                        <span id="trainer_email_err"></span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="joining_date" id="joining_date" placeholder="" id="form-field-15" class="form-control input-sm date-picker" value="{{ $trainer->joining_date }}">
                        <span id="trainer_email_err"></span>
                    </div>
                </div> 
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control input-sm" name="address" disabled>{{ $trainer->address }}</textarea>
                        <span id="trainer_email_err"></span>
                    </div>
                </div> 
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control input-sm" name="trainer_note" disabled>{{ $trainer->trainer_note }}</textarea>
                        <span id="trainer_email_err"></span>
                    </div>
                </div>                                
                <div class="form-group">
