    ...
    <div class="col-md-12">    
        ...
        <div class="panel panel-white">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">Trial Students Report
                    <div class="mig-wrap" style="float:right;padding-right:30px;">
                        <a class="btn btn-primary" style="float:left;margin-right:3px;" href="{{ URL::to('reports/trial-students/export') }}">Export</a>
                    </div>
                </h3>            
            </div>
            ...
            <div class="panel-body">
                <div id="reportView">
                    <table class="table table-striped table-bordered table-hover table-full-width" id="report">
                        ...
                        <tbody>
                            @foreach($trialstd_list as $key=> $student)
                                <tr>
                                    <td>{{ $student->id }}</td>
                                    <td>{{ $student->name }}</td>
