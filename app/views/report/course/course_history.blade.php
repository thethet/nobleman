            ...
            <div class="panel-heading">
                <h3 class="panel-title">Course History
                    <div class="mig-wrap" style="float:right;padding-right:30px;">
                        <a class="btn btn-primary" style="float:left;margin-right:3px;" href="{{ URL::to('reports/course-history/export') }}">Export</a>
                    </div>
                </h3>   
                        ...
                        <tbody>
                            @foreach($course_history as $key=> $value)
                                <tr>
                                   ...
                                   <td>{{StudentCourseEntry::where('date_of_registration','like',$current_year.'%')->groupBy('course_id')->count()}}</td>
                                   <td>{{$current_year}}</td>
                                </tr>   
                            @endforeach
                        </tbody>
