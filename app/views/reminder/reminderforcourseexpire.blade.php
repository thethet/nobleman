    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-white">
            <div class="panel-heading">
                <h3 class="panel-title">Reminder For <span class="text-bold">Course Expire</span></h3>
                ...
                <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                    ...
                    @foreach($appointment as $key => $value)
                        <tr>
                            ...
                            <td>{{$value->date}}</td>
                            <td>{{AppointmentEntry::where('attend','=','0')->where('booking_status','=','book')->where('date','=',$yesterday)->groupBy('course_id')->count()}}</td>
                            <td>
                               {{ Form::open(array('url'=>'reminderforcourseexpire/sendemailfor-courseexpire','method'=>'post')) }}
