    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-white">
            <div class="panel-heading">
                <h3 class="panel-title">Reminder To <span class="text-bold">Trainers</span></h3>
                ...
                <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                    ...
                    @foreach($trainer_schedule as $key => $value)
                        <tr>
                            ...
                            <td>{{$value->date}}</td>
                            <td>{{TrainerScheduleEntry::where('date','=',$next2day)->groupBy('course_id')->count()}}</td>
                            <td>
                               {{ Form::open(array('url'=>'remindertotrainers/sendemailtotrainers','method'=>'post')) }}
