...
@section('content')
{{ Form::open(array('url'=>'holiday/'.$holiday->id,'method'=>'post','role'=>'form','class'=>'form-horizontal')) }}
<div class="col-sm-6">
    @if ($errors->has())
    ...
    <div class="panel panel-white">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input disabled type="text" name="hf_date" value="{{$holiday->hf_date}}" id="hf_date" class="form-control input-sm" required="">
                </div>
                <div class="col-sm-2">
                    <input disabled type="text" name="ht_date" value="{{$holiday->ht_date}}" id="ht_date" class="form-control input-sm" required="">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input disabled type="text" name="holiday_name" placeholder="" value="{{$holiday->h_name}}" id="form-field-13" class="form-control input-sm" required="">
                </div>
            </div>
