        ...
        <div class="panel panel-white">
            <div class="panel-heading">
                <h3 class="panel-title">Attendance <span class="text-bold">List</span>
                    ...
                    {{ Form::open(array('url'=>'trainer/attendance/filterexport','method'=>'post')) }}
                    ...
                    <tbody>
                        ...
                        foreach($trainer_schedule as $key=> $ts_data){
                            ...
                            foreach($t_appointment as $app_data) {
                                ...
                                echo '<tr>';
                                echo Form::open(array('url'=>'trainer/attendanceflt','method'=>'post','id'=>$app_data -> id));
                                echo '<input type="hidden" name="getdate" id="getdate" value="'.$getdate.'" />';
                                echo '<td>';
                               ...
                               /* echo '<td>';
                                ...
                                echo '<button type="submit" name="attend" class="btn btn-info" value="1" disabled="disabled"><i class="fa fa-check-square"></i></button>&nbsp;';
                                echo '<button type="submit" name="absence" class="btn btn-danger" disabled="disabled"><i class="fa fa-times"></i> </button>';
                                }else{
