...
@section('content')
{{ Form::open(array('url'=>'remindertotrainers-template','method'=>'post','role'=>'form','class'=>'form-horizontal','files'=>'true','name'=>'temtrafrm')) }}
<div class="col-sm-12">
    ...
    <div class="panel panel-white">
        <div class="panel-heading">
            <h4 class="panel-title">Reminder To Trainers Template</h4>
        </div>
