...
@section('content')
{{ Form::open(array('url'=>'reminderforcourseexpire-template','method'=>'post','role'=>'form','class'=>'form-horizontal','files'=>'true','name'=>'temcoufrm')) }}
<div class="col-sm-12">
    ...
    <div class="panel panel-white">
        <div class="panel-heading">
            <h4 class="panel-title">Reminder For Course Expire Template</h4>
        </div>
...
<!-- {{ HTML::script("https://cdnjs.cloudflare.com/ajax/libs/jquery/1.11.0/jquery.min0.js") }} -->
