...
@section('content')
{{ Form::open(array('url'=>'remindertotrialstudents-template','method'=>'post','role'=>'form','class'=>'form-horizontal','files'=>'true','name'=>'temtrialstdfrm')) }}
<div class="col-sm-12">
    ...
    <div class="panel panel-white">
        <div class="panel-heading">
            <h4 class="panel-title">Reminder To Trial Student Template</h4>
        </div>
