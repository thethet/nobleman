...
<div class="col-md-12">
    ...
    <div class="panel panel-white">
        <div class="panel-heading">
            <h3 class="panel-title">Payment received for month
            </h3>
        </div>
        ...
        <div class="form-group ptxt">
            ...
            <div class="mig-wrap" style="float:left;padding-left:15px;">
                <a class="btn btn-primary" style="float:left;margin-right:3px;" href="{{ URL::to('payment/export') }}">Export</a>
            </div>
            {{ Form::close() }}
        </div>
        ...
        <table class="display" id="sample_2">
                ...
                @foreach($students as $key=> $students)
                    <tr>
                        <td>{{$students->name}}</td>
                        <td>
                        {{ DB::table('courses')->where('id','=',$students->course_id)->pluck('course_name')}}
                        ...
                        <td>
                            {{ Form::open(array('url'=>'payment/changestatus111/'.$students->id,'method'=>'put','role'=>'form','class'=>'form-horizontal')) }}
