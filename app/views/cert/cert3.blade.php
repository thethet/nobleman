...
@section('content')
    {{ Form::open(array('url'=>'cert/cert3','method'=>'post','role'=>'form','class'=>'form-horizontal')) }}
    <div class="col-sm-12">
        @if ($errors->has())
            ...
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h4 class="panel-title">Create Certificate<span class="text-bold"> 3</span></h4>
                </div>
    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-white">
            <div class="panel-body right padding">
                ...
                <a href="{{ URL::to('/cert/cert3') }}"><input type="button" class="btn btn-warning" value="Back"></a>
            </div>
        </div>
    </div>
    {{ Form::close() }}
