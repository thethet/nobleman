    ...
    <div class="panel panel-white">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="name" placeholder="" id="form-field-13" class="form-control input-sm" value="N101-1">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="form-field-13">
                ...
                <div class="col-sm-9">
                    <input type="text" name="name" placeholder="" id="form-field-13" class="form-control input-sm" value="Flower arrangement">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="form-field-13">
                ...
                <div class="col-sm-9">
                    <input type="text" name="nric" placeholder="" id="form-field-13" class="form-control input-sm" value="Floral Courses">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="form-field-13">
                ...
                <div class="col-sm-9">
                    <input type="text" name="nric" placeholder="" id="form-field-13" class="form-control input-sm" value="200">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="form-field-13">
