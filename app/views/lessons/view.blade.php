...
@section('content')
    {{ Form::open(array('url'=>'lessons/'.$lesson->id,'method'=>'post','role'=>'form','class'=>'form-horizontal')) }}
    <div class="col-sm-6">
        @if ($errors->has())
        ...
        <div class="panel panel-white">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input disabled type="text" name="lesson_code" placeholder="" id="form-field-13" class="form-control input-sm" value="{{$lesson->lesson_code}}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="form-field-13">
                    ...
                    <div class="col-sm-9">
                        <input disabled type="text" name="lesson_name" placeholder="" id="form-field-13" class="form-control input-sm" value="{{$lesson->lesson_name}}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select disabled class="col-sm-12" name="lesson_type">
                            @foreach ($lesson_type as $lessontype)
                            <option @if($lesson->lesson_type == $lessontype['name']) selected @endif value="{{ $lessontype['name'] }}">
                                {{ $lessontype['name'] }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select disabled class="col-sm-12" name="module_name">
                            @foreach ($modules as $key => $modules)
                                <option @if($lesson->module_name == $modules->module_name) selected @endif value="{{ $modules -> module_name }}">
                                    {{ $modules -> module_name }}
                                </option>
                            @endforeach
                        </select>
